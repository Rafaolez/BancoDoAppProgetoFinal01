...
namespace BancoProgetoFinal01.Migrations
{
    ...
    [Migration("20240605143535_Ajuste-Obs")]
    partial class AjusteObs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BancoProjetoFinal1.Models.Observacoes", b =>
                {
            ...
            modelBuilder.Entity("BancoProjetoFinal1.Models.Pessoa", b =>
                {
                    b.Property<int>("PessoaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BancoProjetoFinal1.Models.Usuario", b =>
                {
                    b.Property<int>("UsuarioId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BancoProjetoFinal1.Models.Observacoes", b =>
                {
                    b.HasOne("BancoProjetoFinal1.Models.Pessoa", "Pessoa")
                        .WithMany()
                        .HasForeignKey("PessoaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BancoProjetoFinal1.Models.Usuario", "Usuario")
                        .WithMany()
